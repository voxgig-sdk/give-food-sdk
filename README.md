...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/give-food` | `npm install @voxgig-sdk/give-food` |
| Python | `voxgig-sdk-give-food` | `pip install voxgig-sdk-give-food` |
| PHP | `voxgig-sdk/give-food` | `composer require voxgig-sdk/give-food` |
| Golang | `github.com/voxgig-sdk/give-food-sdk/go` | `go get github.com/voxgig-sdk/give-food-sdk/go` |
| Ruby | `voxgig-sdk-give-food` | `gem install voxgig-sdk-give-food` |
| Lua | `voxgig-sdk-give-food` | `luarocks install voxgig-sdk-give-food` |

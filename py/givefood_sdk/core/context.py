...
from givefood_sdk.core.control import GiveFoodControl
...
from givefood_sdk.core.helpers import get_ctx_prop, to_map
...
class GiveFoodContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, GiveFoodResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, GiveFoodResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return GiveFoodError(code, msg, self)

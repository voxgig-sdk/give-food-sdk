...
from givefood_sdk.utility import register

# Load features
from givefood_sdk.feature.base_feature import GiveFoodBaseFeature
from givefood_sdk.features import _has_feature, _make_feature
...
class GiveFoodSDK:
    ...
    def get_utility(self):
        return GiveFoodUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("GiveFoodSDK: graphql: " + str(msg))
            res["graphql"] = errors

# GiveFood SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions GiveFoodSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both GiveFoodSDK(...) and GiveFoodSDK.test(...) become
#      GiveFoodSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "givefood_sdk"
_SDK_CLASS = "GiveFoodSDK"

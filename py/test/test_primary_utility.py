...
from givefood_sdk.core.spec import GiveFoodSpec
from givefood_sdk.core.result import GiveFoodResult
from givefood_sdk.core.response import GiveFoodResponse
from givefood_sdk.core.operation import GiveFoodOperation
from givefood_sdk.core.error import GiveFoodError
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = GiveFoodSDK.test(None, None)
        ...
        class TestInitFeature(GiveFoodBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(GiveFoodBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = GiveFoodSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = GiveFoodSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = GiveFoodSDK.test(None, setup_opts)

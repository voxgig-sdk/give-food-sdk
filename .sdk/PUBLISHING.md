...
|---|---|---|
| `ts/` | @voxgig-sdk/give-food-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/give-food-sdk \
      --repository voxgig-sdk/give-food-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/give-food-sdk` shows it, and
`npm trust revoke @voxgig-sdk/give-food-sdk --id=<id>` removes it.

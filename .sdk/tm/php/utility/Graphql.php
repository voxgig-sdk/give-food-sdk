...
class GiveFoodGraphql
{
    ...
    // equivalent.
    public static function body(GiveFoodContext $ctx): mixed
    {
    ...
    public static function errors(GiveFoodContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;

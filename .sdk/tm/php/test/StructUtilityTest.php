...
// GiveFood SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = GiveFoodOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(GiveFoodOmni::structfix($now, Struct::undef()))
                        !== json_encode(GiveFoodOmni::structfix($val, Struct::undef()))) {

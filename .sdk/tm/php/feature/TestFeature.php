...
// GiveFood SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class GiveFoodTestFeature extends GiveFoodBaseFeature
{
    ...
    public function init(GiveFoodContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (GiveFoodContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (GiveFoodContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(GiveFoodContext $ctx, $op, $args): array
    {

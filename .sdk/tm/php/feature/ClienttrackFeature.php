...
// GiveFood SDK clienttrack feature
...
class GiveFoodClienttrackFeature extends GiveFoodBaseFeature
{
    ...
    public function PostConstruct(GiveFoodContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'GiveFood-SDK';

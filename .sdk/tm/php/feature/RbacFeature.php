...
class GiveFoodRbacFeature extends GiveFoodBaseFeature
{
    ...
    private function _required(GiveFoodContext $ctx): ?string
    {
    ...
    private function _reject(GiveFoodContext $ctx, string $required): void
    {
    ...
    private function _track(GiveFoodContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;

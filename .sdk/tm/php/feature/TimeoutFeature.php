...
class GiveFoodTimeoutFeature extends GiveFoodBaseFeature
{
    ...
    private function _with_timeout(GiveFoodContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(GiveFoodContext $_ctx, float $ms): void
    {
        $client = $this->client;

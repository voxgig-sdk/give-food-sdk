...
class GiveFoodProxyFeature extends GiveFoodBaseFeature
{
    ...
    public function init(GiveFoodContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (GiveFoodContext $ctx2, string $url2, array $fetchdef) use ($inner): array {

...
// GiveFood SDK streaming feature
...
class GiveFoodStreamingFeature extends GiveFoodBaseFeature
{
    ...
    private function _iterate(GiveFoodResult $result): \Generator
    {
    ...
    private function _streamable(GiveFoodContext $ctx): bool
    {

...
// GiveFood SDK ratelimit feature
...
class GiveFoodRatelimitFeature extends GiveFoodBaseFeature
{
    ...
    private function _acquire(GiveFoodContext $ctx): void
    {
    ...
    private function _track(GiveFoodContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

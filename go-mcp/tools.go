...
func registerTools(server *mcp.Server, client *sdk.GiveFoodSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "give-food_list",
		Description: "List records from GiveFood. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "give-food_load",
		Description: "Load a single record from GiveFood. " +
...
func runOp(client *sdk.GiveFoodSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.GiveFoodSDK, name string) (sdk.GiveFoodEntity, error) {

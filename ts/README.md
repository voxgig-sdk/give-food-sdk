# GiveFood TypeScript SDK

The TypeScript SDK for the GiveFood API. Provides a type-safe, entity-oriented interface with full async/await support.
...
| Method | Returns | Description |
| --- | --- | --- |
| `GiveFoodSDK.test(testopts?, sdkopts?)` | `GiveFoodSDK` | Create a test-mode client. |

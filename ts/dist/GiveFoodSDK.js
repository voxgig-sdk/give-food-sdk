...
Object.defineProperty(exports, "GiveFoodEntityBase", { enumerable: true, get: function () { return GiveFoodEntityBase_1.GiveFoodEntityBase; } });
...
class GiveFoodSDK {
    ...
    async direct(fetchargs) {
        if (!this._options.allow.op.includes('direct')) {
            return {
                ok: false,
                err: new Error('GiveFoodSDK: direct: operation not allowed by' +
    ...
    async graphql(query, variables, ctrl) {
        ...
        if (!options.allow.op.includes('graphql')) {
            return {
                ok: false,
                err: new Error('GiveFoodSDK: graphql: operation not allowed by' +
        ...
        if (null != errors && Array.isArray(errors) && 0 < errors.length) {
            ...
            const err = new Error('GiveFoodSDK: graphql: ' +
...
exports.GiveFoodSDK = GiveFoodSDK;
const SDK = GiveFoodSDK;
exports.SDK = SDK;
//# sourceMappingURL=GiveFoodSDK.js.map
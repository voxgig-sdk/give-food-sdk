...
function envOverride(m) {
    if ('TRUE' === process.env.GIVE_FOOD_TEST_LIVE ||
        'TRUE' === process.env.GIVE_FOOD_TEST_OVERRIDE) {
    ...
    m.GIVE_FOOD_TEST_EXPLAIN = process.env.GIVE_FOOD_TEST_EXPLAIN || m.GIVE_FOOD_TEST_EXPLAIN;
    return m;
}

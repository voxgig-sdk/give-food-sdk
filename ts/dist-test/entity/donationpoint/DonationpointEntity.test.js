...
(0, node_test_1.describe)('DonationpointEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(donationpoint_ref01_data_dt0.id === donationpoint_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/donationpoint/DonationpointTestData.json');
    ...
    let idmap = transform(['donationpoint01', 'donationpoint02', 'donationpoint03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=DonationpointEntity.test.js.map
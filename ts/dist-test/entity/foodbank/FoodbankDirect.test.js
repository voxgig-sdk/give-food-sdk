...
(0, node_test_1.describe)('FoodbankDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-foodbank', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-foodbank', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-foodbank', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-foodbank', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GIVE_FOOD_TEST_FOODBANK_ENTID'];
...
//# sourceMappingURL=FoodbankDirect.test.js.map
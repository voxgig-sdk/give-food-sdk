...
local GiveFoodSDK = {}
GiveFoodSDK.__index = GiveFoodSDK
...
GiveFoodSDK._make_feature = _make_feature


function GiveFoodSDK.new(options)
  local self = setmetatable({}, GiveFoodSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function GiveFoodSDK:options_map()
...
function GiveFoodSDK:get_utility()
  return Utility.copy(self._utility)
end


function GiveFoodSDK:get_root_ctx()
  return self._rootctx
end


function GiveFoodSDK:prepare(fetchargs)
...
function GiveFoodSDK:direct(fetchargs)
...
-- by passing it.
function GiveFoodSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function GiveFoodSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "GiveFoodSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function GiveFoodSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = GiveFoodSDK.new(sdkopts)
  sdk.mode = "test"

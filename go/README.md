...
The Golang SDK for the GiveFood API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.
...
```bash
go mod edit -replace github.com/voxgig-sdk/give-food-sdk/go=../path/to/github.com/voxgig-sdk/give-food-sdk/go
```

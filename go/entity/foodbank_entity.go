...
func NewFoodbankEntity(client *core.GiveFoodSDK, entopts map[string]any) *FoodbankEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FoodbankEntity) GetName() string { return e.name }
...
func (e *FoodbankEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FoodbankEntity) Deleted() bool {
	return e.deleted
}


func (e *FoodbankEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFoodbankEntity(e.client, opts)
}

func (e *FoodbankEntity) Data(args ...any) any {
...
func (e *FoodbankEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Foodbank; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FoodbankEntity) DataTyped(data ...Foodbank) Foodbank {
	if len(data) > 0 {
		return typedFrom[Foodbank](e.Data(asMap(data[0])))
	}
	return typedFrom[Foodbank](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Foodbank (all fields
// optional at the wire level).
func (e *FoodbankEntity) MatchTyped(match ...Foodbank) Foodbank {
	if len(match) > 0 {
		return typedFrom[Foodbank](e.Match(asMap(match[0])))
	}
	return typedFrom[Foodbank](e.Match())
}
...
func (e *FoodbankEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FoodbankEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FoodbankLoadMatch and returns an Foodbank. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *FoodbankEntity) LoadTyped(reqmatch FoodbankLoadMatch, ctrl map[string]any) (Foodbank, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Foodbank{}, err
	}
	return typedFrom[Foodbank](res), nil
}




func (e *FoodbankEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// FoodbankListMatch and returns []Foodbank. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *FoodbankEntity) ListTyped(reqmatch FoodbankListMatch, ctrl map[string]any) ([]Foodbank, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Foodbank](res), nil
}



func (e *FoodbankEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FoodbankEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FoodbankEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FoodbankEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

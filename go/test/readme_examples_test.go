...
const testSeed = `map[string]any{"entity": map[string]any{"article": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "donationpoint": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "foodbank": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "item": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`

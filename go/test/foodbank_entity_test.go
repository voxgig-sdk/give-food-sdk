...
func TestFoodbankEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set GIVEFOOD_TEST_FOODBANK_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func foodbankBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("GIVEFOOD_TEST_FOODBANK_ENTID")
	...
	idmapResolved := core.ToMapAny(env["GIVEFOOD_TEST_FOODBANK_ENTID"])

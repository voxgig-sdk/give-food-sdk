...
func TestDonationpointEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set GIVEFOOD_TEST_DONATIONPOINT_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func donationpointBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("GIVEFOOD_TEST_DONATIONPOINT_ENTID")

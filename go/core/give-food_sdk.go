...
func (sdk *GiveFoodSDK) OptionsMap() map[string]any {
...
func (sdk *GiveFoodSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *GiveFoodSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *GiveFoodSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *GiveFoodSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *GiveFoodSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *GiveFoodSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("GiveFoodSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *GiveFoodSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *GiveFoodSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("GiveFoodSDK: graphql: %s", msg)
		res["graphql"] = errors
	}

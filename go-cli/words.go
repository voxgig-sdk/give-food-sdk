...
func registerSDKWords(r *eng.Registry, client *sdk.GiveFoodSDK) {
...
func runOp(client *sdk.GiveFoodSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {

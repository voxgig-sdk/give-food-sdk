...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = GiveFoodOmni.make_runner(TEST_JSON_FILE, GiveFoodSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : GiveFoodOmni.errify(err)
    end

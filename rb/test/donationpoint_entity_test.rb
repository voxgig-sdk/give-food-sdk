...
class DonationpointEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set GIVEFOOD_TEST_DONATIONPOINT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def donationpoint_basic_setup(extra)
  ...
  entid_env_raw = ENV["GIVEFOOD_TEST_DONATIONPOINT_ENTID"]

...
The PHP SDK for the GiveFood API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Article(null)->list(null, null);
...
[$result, $err] = $client->GiveFood(null)->load(
    ["id" => "test01"], null
);

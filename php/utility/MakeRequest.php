...
// GiveFood SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class GiveFoodMakeRequest
{
    public static function call(GiveFoodContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new GiveFoodResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new GiveFoodResponse($fetched);
        } else {

...
class GiveFoodNetsimFeature extends GiveFoodBaseFeature
{
    ...
    private function _simulate(GiveFoodContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(GiveFoodContext $ctx, array $applied): void
    {
        $client = $this->client;

...
class GiveFoodCacheFeature extends GiveFoodBaseFeature
{
    ...
    private function _through(GiveFoodContext $ctx, string $url, array $fetchdef, callable $inner): array
    {

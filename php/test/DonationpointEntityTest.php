...
class DonationpointEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set GIVEFOOD_TEST_DONATIONPOINT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function donationpoint_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("GIVEFOOD_TEST_DONATIONPOINT_ENTID");

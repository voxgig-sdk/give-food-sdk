...
// GiveFood SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (GiveFoodSDK::test)
...
{
    private const SDK_CLASS = 'GiveFoodSDK';
    ...
    private const SDK_BASE = 'givefood_sdk';
